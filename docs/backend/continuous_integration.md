...
## Setting up jainmickey with Drone.io Continuous Integration
...
5. Select ` jainmickey-web ` for your repo
...
1. Click ( "Deployment" )[https://drone.io/github.com/jainmickey/jainmickey-web/admin/deployments#/]
...
4. Add `https://git.heroku.com:jainmickey-dev.git` under the Application Git URL
...
8. To have deployment for other branches including testing and production repeat steps 3 --> 7 with:
    - jainmickey-qa for branch qa
    - jainmickey-prod for branch prod
