...
In your terminal, type or copy-paste the following:
    ...
    git clone git@github.com:jainmickey/jainmickey-web.git; cd jainmickey-web; fab init
...
[contributing]: http://github.com/jainmickey/jainmickey-web/tree/master/CONTRIBUTING.md
