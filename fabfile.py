...
def dev():
    ...
    env.remote = 'origin'
    env.branch = 'master'
    env.hosts = ['qa.jainmickey.com']
    env.dotenv_path = '/home/ubuntu/dev/jainmickey/.env'
...
def qa():
    ...
    env.branch = 'qa'
    env.hosts = ['qa.jainmickey.com']
    env.dotenv_path = '/home/ubuntu/qa/jainmickey/.env'
    env.config_setter = fab.run
...
def prod():
    ...
    env.remote = 'origin'
    env.branch = 'prod'
    env.hosts = ['prod.jainmickey.com']
    env.dotenv_path = '/home/ubuntu/prod/jainmickey/.env'
    env.config_setter = fab.run
